...
Version  : 1.0.10
Release  : 42
URL      : https://cran.r-project.org/src/contrib/DEoptimR_1.0-10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/DEoptimR_1.0-10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641317353
